...
<!-- ##### Header Area End ##### -->
    ...
    <div align="center" style="margin-top: 55px;">
        <div class="container">
            <div class="row" style="margin-right: 361px;">
                	<div class="col-3"></div>
                	<div class="col-3">
							...
							<div id="table_search">
								<form action="serviceBoard.do" method="get">
							...
							<c:if test="${ pageDtoService.count gt 0 }">
								...
								<c:if test="${ pageDtoService.startPage gt pageDtoService.pageBlock }">
									<a href="serviceBoard.do?pageNum=${ pageDtoService.startPage - pageDtoService.pageBlock }&category=${ pageDtoService.category }&search=${ pageDtoService.search }">[이전]</a>
								</c:if>
								...
								<c:forEach var="i" begin="${ pageDtoService.startPage }" end="${ pageDtoService.endPage }" step="1">
									...
									<c:when test="${ i eq pageNum }">
										<a href="serviceBoard.do?pageNum=${ i }&category=${ pageDtoService.category }&search=${ pageDtoService.search }" class="active">[${ i }]</a>
									</c:when>
									<c:otherwise>
										<a href="serviceBoard.do?pageNum=${ i }&category=${ pageDtoService.category }&search=${ pageDtoService.search }">[${ i }]</a>
									</c:otherwise>
									</c:choose>
								...
								<c:if test="${ pageDtoService.endPage lt pageDtoService.pageCount }">
									<a href="serviceBoard.do?pageNum=${ pageDtoService.startPage + pageDtoService.pageBlock }&category=${ pageDtoService.category }&search=${ pageDtoService.search }">[다음]</a>
								</c:if>
							</c:if>
