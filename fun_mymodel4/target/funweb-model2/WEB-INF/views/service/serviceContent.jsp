...
<body>
    ...
    <!-- ##### Search Area Start ##### -->
    <div class="bueno-search-area section-padding-100-0 pb-70 bg-img" style="margin-left: 337px;">
        <div class="container">
            <div class="row">
                <div class="col-3">
                        ...
                        <div class="row">
                            <div>
                                <div class="form-group mb-30">
									...
									<table id="service" border="1" class="table table-striped">
										<tr>
