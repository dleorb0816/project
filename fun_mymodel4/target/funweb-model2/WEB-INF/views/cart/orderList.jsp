...
<body>
	...
	if (id != null) {
		...
		out.println("<table border =\"0\" style=\"border-spacing: 0px;width: 600px;\">");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주문 날짜</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주문자</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주소</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">상품</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">수량</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">가격</th>");
		out.println("<tr>");
		...
		out.println("<tr align= 'center'>");
		out.println("<td style=\"height:60px\">" + userOrderVo.getOrder_date() + "</td>");
		out.println("<td style=\"height:60px\">" + userOrderVo.getName() + "</td>");
		out.println("<td style=\"height:60px\">" + userOrderVo.getAddress() + "</td>");
		out.println("<td style=\"height:60px\">" + userOrderVo.getProduct() + "</td>");
		out.println("<td style=\"height:60px\">" + userOrderVo.getP_count() + "</td>");
		...
		out.println("<div align=\"center\" >");
		out.println("<table  border =\"0\" style=\"border-spacing: 0px;width: 600px;\">");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주문 번호</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주문 날짜</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주문자</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">주소</th>");
		out.println("<th style=\"border-bottom: 1px solid black;text-align: center;\">상품</th>");
		...
		out.println("<tr align= 'center'>");
		out.println("<td style=\"height:60px\">" + orderVo.getId() + "</td>");
		out.println("<td style=\"height:60px\">" + orderVo.getOrder_date() + "</td>");
		out.println("<td style=\"height:60px\">" + orderVo.getName() + "</td>");
		out.println("<td style=\"height:60px\">" + orderVo.getAddress() + "</td>");
		out.println("<td style=\"height:60px\">" + orderVo.getProduct() + "</td>");
		out.println("<td style=\"height:60px\">" + orderVo.getP_count() + "</td>");
