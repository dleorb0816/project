            ...
            <div class="row">
                ...
                <div class="col-3">
                    <form action="userLoginPro.do" method="post">
                        <div class="row">
                            <div>
                                <div class="form-group mb-30" style="margin-left: 123px">
                                	<fieldset style="width: 305px;" align="center">
										<legend class="post-title">Login Info</legend>
										
										<label>User ID</label><br>
										<input type="text" name="id" autofocus style="width: 305px"><br>
										
										<label>Password</label><br>
										<input type="password" name="pwd" style="width: 305px"><br>
										
										<label>로그인 상태 유지</label>
										<input type="checkbox" name="keepLogin" value="true"><br>
										체크하면 10분 동안 로그인 상태가 유지됩니다.
										<br>
										<button class="btn bueno-btn w-100">Login</button>
									</fieldset>
                                </div>
                            </div>
                        </div>
