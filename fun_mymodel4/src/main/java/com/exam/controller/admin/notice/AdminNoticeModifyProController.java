...
public class AdminNoticeModifyProController implements Controller {

	@Override
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
			System.out.println("AdminNoticeModifyProController....");
			...
			for (String delFileNum : delFileNums) {
				...
				NoticeAttachVo attachVo = attachDao.getAttachByNum(num);
		...
		String rtn = "redirect:/adminNoticeBoard.do?num=\"+noNum+\"&pagenum=\"+pageNum";
		return "redirect:/adminNoticeBoard.do?num=\"+noNum+\"&pagenum=\"+pageNum";
	}
