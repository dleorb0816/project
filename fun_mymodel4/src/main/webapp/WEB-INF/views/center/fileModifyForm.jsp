...
<div id="wrap" align="center">
	...
	<input type="hidden" name="num" value="${ fileVo.num }">
	<table id="notice" border="2">
		<tr>
			<th scope="col" class="twrite">작성자</th>
			<td class="left" width="500">
				<input type="text" name="id" value="${ fileVo.id }" readonly style="border: none;">
			</td>
		</tr>
		<tr>
			<th scope="col" class="ttitle">글제목</th>
			<td class="left">
				<input type="text" name="subject" value="${ fileVo.subject }" style="width: 509px; border: none;">
			</td>
		</tr>
		<tr>
			<th scope="col" class="ttitle">글내용</th>
			<td class="left">
				<textarea rows="13" cols="70" name="content">${ fileVo.content }</textarea>
			</td>
		</tr>
		<tr>
	...
	<div id="table_search">
		...
		<input type="button" value="목록보기" class="btn" onclick="location.href = 'fileBoard.do?pageNum=${pageNum}'">
	</div>
	</form>
