...
public class NetworkSearch extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://192.168.219.100/MyDBProject/testDB4_search.jsp";
    ...
    protected void onPostExecute(String s) {
        ...
        ArrayList<ContentInfo> contentList = new ArrayList<ContentInfo>();
        int count = 0;
        try{
            count = JsonParser.getContentInfoJson(s,contentList);
