...
public class BNetworkSearch extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://192.168.219.100/MyDBProject/testDB4_bsearch.jsp";
    private Bcustom_Adapter adapter;

    public BNetworkSearch(Bcustom_Adapter adapter) {
